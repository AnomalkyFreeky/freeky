...
FREEKY.data.facilityModules = [
  ...
  {id:'manifestctl',  no:'09', name:'Manifest Control',  minLevel:50, status:'live'},
  {id:'dossierctl',   no:'10', name:'Dossier Control',   minLevel:80, status:'live'},
  {id:'quizctl',      no:'11', name:'Quiz Control',      minLevel:80, status:'live'},
  {id:'anomalkyctl',  no:'12', name:'ANOMAL-KY Control', minLevel:99, status:'live'},
  {id:'randomctl',    no:'13', name:'Random Content',    minLevel:80, status:'live'},
  ...
  {id:'database',     no:'17', name:'Database',          minLevel:99, status:'live'},
  {id:'media',        no:'18', name:'Media Library',     minLevel:50, status:'live'},
